...
// Validate token against Discord REST API before connecting to gateway
...
restCheck.get('/users/@me').then(data => {
  ...
  console.error('[TOKEN INVALID] Fix: update DISCORD_BOT_TOKEN in Render with the new token');
  process.exit(1);
});
